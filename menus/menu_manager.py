...
class MenuManager:
    ...
    def create_popup_menus(self):
        self.popup_menus["arquivo"] = criar_menu_arquivo(self.root, self.callback)
        self.popup_menus["transf"] = criar_menu_transformacoes(self.root, self.callback)
        self.popup_menus["filtros"] = criar_menu_filtros(self.root, self.callback)
        self.popup_menus["morfo"] = criar_menu_morfologia(self.root, self.callback)
        self.popup_menus["extracao"] = criar_menu_extracao(self.root, self.callback)
